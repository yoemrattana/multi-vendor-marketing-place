  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
            <form id="form-general" method="post" action="<?php echo base_url() ?>admin/products/edit_status">
                
                <div class="form-group">
       
                    <input type="text" name="product_id" class="form-control validate[required]">
                </div>
                <div class="form-group">
